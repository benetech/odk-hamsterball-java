...
public class ThumbnailUtils {
  ...
  public static byte[] thumbnail(FileWrapper original) {
    BufferedImage originalBufferedImage = null;
    BufferedImage thumbnailBufferedImage = null;
    ByteArrayOutputStream byteArrayOutputStream = null;
    try {
      originalBufferedImage = ImageIO.read(original.getFile());
      ...
      ImageIO.write(thumbnailBufferedImage, original.getExtension(), byteArrayOutputStream);
