...
public class DBUtil {
  ...
  public static void teardownDatabase(Connection conn, String schemaName) throws SQLException {
    Log logger = LogFactory.getLog(DBUtil.class);
  ...
  public static void setupEmptyDatabase(Connection conn, String username, String schemaName) throws SQLException {
